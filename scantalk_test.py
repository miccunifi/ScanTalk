...
sys.path.append('./model/diffusion-net_/src')
...
def main():
    ...
    parser.add_argument("--actor_file_voca", type=str, default="/equilibrium/fnocentini/Datasets/vocaset/templates.pkl", help='templates')
    parser.add_argument("--actor_file_biwi", type=str, default="/equilibrium/fnocentini/Datasets/Biwi_6/templates", help='templates')
    parser.add_argument("--actor_file_multiface", type=str, default="/equilibrium/fnocentini/Datasets/Multiface/templates", help='templates')
    parser.add_argument("--template_file_voca", type=str, default="/equilibrium/fnocentini/Datasets/vocaset/flame_model/FLAME_sample.ply", help='faces to animate')
    parser.add_argument("--template_file_biwi", type=str, default="/equilibrium/fnocentini/Datasets/Biwi_6/templates/F1.obj", help='faces to animate')
    parser.add_argument("--template_file_multiface", type=str, default="/equilibrium/fnocentini/Datasets/Multiface/templates/20180227.ply", help='faces to animate')
